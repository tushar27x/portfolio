      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-4 relative flex justify-center lg:justify-end order-first lg:order-last p-4">
            ...
            <div className="lg:col-span-8 space-y-12 flex flex-col items-center lg:items-start text-center lg:text-left order-last lg:order-first">
              ...
              <div className="space-y-8 w-full">
                ...
                >
                  SOFTWARE <br />
                  <span className="text-primary italic bg-gradient-to-r from-primary to-primary/50 bg-clip-text text-transparent pr-4">ENGINEER</span>
                </motion.h1>
